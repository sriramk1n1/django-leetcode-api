...
class dsa(models.Model):
    ...
    q1=models.URLField(max_length=150,blank=True,null=True)
    q2=models.URLField(max_length=150,blank=True,null=True)
    q3=models.URLField(max_length=150,blank=True,null=True)
    q4=models.URLField(max_length=150,blank=True,null=True)
    q5=models.URLField(max_length=150,blank=True,null=True)
    r1=models.URLField(max_length=150,blank=True,null=True)
    r2=models.URLField(max_length=150,blank=True,null=True)
